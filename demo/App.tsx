...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'animated-icon', label: 'AnimatedIcon' },
      { id: 'stagger', label: 'Stagger' },
      { id: 'typewriter', label: 'Typewriter' },
      { id: 'glow-pulse', label: 'GlowPulse & Magnetic' },
  ...
  },
  {
    label: 'Layout',
    items: [
      { id: 'stack', label: 'Stack / HStack / VStack' },
      { id: 'grid', label: 'Grid' },
  ...
  },
  {
    label: 'Productivity',
    items: [
      { id: 'pomodoro', label: 'PomodoroTimer' },
      { id: 'kanban', label: 'KanbanBoard' },
      { id: 'habit-tracker', label: 'HabitTracker' },
    ],
  },
  {
    ...
    items: [
      ...
      { id: 'sections', label: 'Pre-built Sections' },
    ],
  },
  {
    ...
    items: [
      ...
      { id: 'button-variants', label: 'Button — All Variants' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { id: 'input-depth', label: 'Input — Full Depth' },
      { id: 'select-depth', label: 'Select — Full Depth' },
      { id: 'card-depth', label: 'Card — Full Depth' },
      { id: 'modal-depth', label: 'Modal — Full Depth' },
      { id: 'tag-input', label: 'TagInput' },
      { id: 'animated-list', label: 'AnimatedList' },
      { id: 'animated-number', label: 'AnimatedNumber' },
      { id: 'presence-avatars', label: 'PresenceAvatars' },
